...
| `WGUI_BACKUP_ENDPOINT_ADDRESS` | The default backup endpoint address used when generating the secondary client config. The generated primary and backup configs differ only in the `Endpoint` line.                                                                                                                    | `wg2.int.automesh.org`             |
